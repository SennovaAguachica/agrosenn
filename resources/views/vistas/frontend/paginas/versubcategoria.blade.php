        ...
        {{-- <div class="archive-header-3 mt-30 mb-80" style="background-image: url(assets/imgs/vendor/vendor-header-bg.png)">
            <div class="archive-header-3-inner">
                <div class="vendor-logo mr-50">
                    <img src="assets/imgs/vendor/vendor-17.png" alt="" />
                </div>
                <div class="vendor-content">
                    <div class="product-category">
                        <span class="text-muted">Since 2012</span>
                    </div>
                    <h3 class="mb-5 text-white"><a href="vendor-details-1.html" class="text-white">Nest Food.,Ltd</a></h3>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="vendor-des mb-15">
                                <p class="font-sm text-white">Got a smooth, buttery spread in your fridge? Chances are good
                                    that it's Good Chef. This brand made Lionto's list of the most popular grocery brands
                    ...
                    @foreach ($publicaciones as $publicacion)
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2><a href="#">{{ $publicacion->productos->producto }}</a></h2>
